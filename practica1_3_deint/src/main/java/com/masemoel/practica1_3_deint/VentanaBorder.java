 ...
 * @author Masemo
 */
public class VentanaBorder extends javax.swing.JDialog {

    /** Creates new form VentanaBorder */
    public VentanaBorder(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Selecciona layout");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaBorder dialog = new VentanaBorder(new javax.swing.JFrame(), true);
